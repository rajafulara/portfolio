    ...
    id="about" className="w-full px-[12%] py-10 scroll-mt-20">
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='w-64 sm:w-80 rounded-3xl max-w-none'>
                <Image src={assets.user_image} alt='user image' className='w-full rounded-3xl' priority={true}/>
            </motion.div>
            <motion.div
            initial={{opacity: 0}}
            whileInView={{opacity: 1}}
            ...
            className='flex-1'>
                <p className='mb-10 max-w-2xl'>I am a frontend developer with over 2 years of personal expertise in this field. Throughout my career, I have had the privilege of collaborating in prestigious projects, contributing to their success and growth.</p>
